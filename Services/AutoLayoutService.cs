...
public class AutoLayoutService
{
    ...
    private NodeModel RootNode { get; set; }

    public AutoLayoutService(NodeModel root)
    {
        this.RootNode = root;
    }
    ...
    public void DoLayout(int space = 40)
    {
        ...
        {
            // Align vertical
            VerticalAlign(this.RootNode, 1);

            // Add dummy nodes for alignments
            AddDummyNodes();

            // Set the size of node
            NodeAlign(this.RootNode);
            
            // Set the sae of the Child nodes
            ContainerAlign(this.RootNode, space);
    ...
    {
        return ToList(this.RootNode, new List<NodeModel>());
    }
